    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
          <div className="flex border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
              <div className="w-16 md:w-20 p-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider border-r dark:border-gray-700">
                  Time
              </div>
              <div className="flex-1 p-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Activities
              </div>
          </div>
          ...
          <div className="divide-y dark:divide-gray-800">
              {HOURS.map(time => (
                  <TimeSlot
                    key={time}
                    time={time}
                    entries={todayEntries.filter(e => e.timeSlot === time)}
                    onAdd={handleAdd}
                    onEdit={handleEdit}
                    onDrop={handleDrop}
                  />
